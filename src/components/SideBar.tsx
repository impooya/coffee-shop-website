...
export default function SideBar({
  ...
  onChangeMobileTheme: () => void;
  darkModeOn: boolean;
  isOpenSideBar: boolean;
  onCloseSideBar: () => void;
}) {
  const [openSubCart, setOpenSubCart] = useState(false);
  return (
    <>
      <svg className="hidden">
        ...
        <symbol
          id="arrow-left-end-on-rectangle"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          strokeWidth="1.5"
      ...
      {/* sidbar  */}
      <div
        className={`absolute z-30 md:hidden flex flex-col w-64 bg-white top-0 py-3 px-4 bottom-0 -mb-1 dark:bg-zinc-700  transition-transform ${
      ...
      >
        ...
        <div className="flex justify-between items-center dark:border-b-white/10 border-b pb-5 border-b-gray-100">
          ...
          >
            <use xlinkHref="#x-min"></use>
          </svg>
        </div>
        {/* sidebar items */}
        <nav className="flex flex-col  gap-4 mt-[19px] border-b border-b-gray-100 text-zinc-700 pb-8 dark:text-white dark:border-b-white/10  ">
          <ul className="[&>*>a]:inline-flex [&>*>a]:gap-2 flex flex-col gap-3  child-hover:text-orange-300 child:p-[10px] child:rounded-md child:flex child:transition-all ">
            <li>
              <a href="">
            ...
            <li className="flex-col group">
              <div className="flex justify-between items-center">
                <a href="#" className="flex gap-2">
                  <svg className="size-5">
                    <use xlinkHref="#shopping-bag"></use>
                  </svg>
                  <span className={`${openSubCart ? "text-orange-300" : ""}`}>
                    فروشگاه
                  </span>
                </a>
                <span
                  onClick={() => {
                    openSubCart ? setOpenSubCart(false) : setOpenSubCart(true);
                  }}
                >
              ...
              {openSubCart && (
                <ul className="text-zinc-600 dark:text-white text-sm mr-[54px]  flex flex-col space-y-3 mt-3 child-hover:list-disc child-hover:text-orange-300 child:transition-all">
                  <li>
                    <a href="">قهوه ویژه</a>
                  </li>
                  <li>
            ...
            <li>
              <a href="">
                <svg className="size-5">
                  <use xlinkHref="#chat-bubble-left"></use>
                </svg>
                <span>دیکشنری</span>
              </a>
            </li>
            ...
            <li>
              <a href="">
                <svg className="size-5">
                  <use xlinkHref="#phone-arrow-up-right"></use>
                </svg>
        ...
        {/*login and toggle theme and shopping cart*/}
        <section className="mt-8 flex flex-col text-orange-300 gap-6">
          <a href="" className="flex gap-2 items-center">
            <svg className="size-5">
              <use xlinkHref="#arrow-left-end-on-rectangle"></use>
            </svg>
            <span>ورود | ثبت‌نام</span>
          </a>
          <div
            className="flex gap-2 items-center cursor-pointer"
            onClick={onChangeMobileTheme}
          >
            {darkModeOn ? (
              <>
                <svg className="size-5">
