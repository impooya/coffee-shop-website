export default function Club() {
  return (
    <>
      ...
      {/*Club Banner*/}
      <div className="flex-wrap lg:flex-nowrap lg:h-36 shadow-normal py-8 lg:py-0 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl flex px-3 xl:px-11 justify-between lg:px-5 lg:gap-x-4 xl:gap-x-24 items-center gap-y-9 ">
        ...
        <div className="flex justify-center items-center gap-x-3 lg:gap-x-4 xl:gap-x-6 md:shrink-0 ">
          <img
            src="/CoffeeShop-Files/club/diamond.png"
            alt="diamond club"
            className="w-[87px] lg:w-[100px] xl:w-[110px]"
          />
          <div className=" flex flex-col gap-2 text-white ">
            <h4 className="text-2xl md:text-5xl font-MorabbaBold ">
              کافی کلاب
            </h4>
            <p className="font-MorabbaLight text-lg md:text-2xl leading-[48px]">
              میدونستی میتونی با امتیاز هات قهوه بگیری ؟
            </p>
          </div>
        </div>
        {/*(Activity and Discovery and Ticket-star Box ) and (Earn Score )*/}

        <div className="flex  justify-between items-center w-full">
          {/*(Activity and Discovery and Ticket-star Box ---> ) */}
          <div className="flex justify-center items-center gap-x-2 lg:gap-x-3 xl:gap-x-5 child:md:size-[98px] child:size-[72px]">
            <div className="flex flex-col gap-1 md:gap-1.5 justify-center items-center bg-white px-[25px] py-1.5 md:pt-5 md:pb-1 rounded-2xl ">
              <svg className="size-10 md:size-12">
                <use xlinkHref="#Discovery"></use>
              </svg>
              <span className="text-center text-xs  md:text-sm text-emerald-600 h-5 w-[66px]">
                چرخ و بخت
              </span>
            </div>
            <div className="flex flex-col gap-1 md:gap-1.5 justify-center items-center bg-white px-[25px] py-1.5 md:pt-5 md:pb-1 rounded-2xl">
              <svg className="size-10 md:size-12">
                <use xlinkHref="#Activity"></use>
              </svg>
              <span className="text-center text-xs md:text-sm text-emerald-600 h-5 w-16">
                ماموریت ها
              </span>
            </div>
            <div className="flex flex-col gap-1 md:gap-1.5 justify-center items-center bg-white px-[25px] py-1.5 md:pt-5 md:pb-1 rounded-2xl">
              <svg className="size-10 md:size-12">
                <use xlinkHref="#Ticket-Star"></use>
              </svg>
              <span className="text-center text-xs md:text-sm text-emerald-600 h-5 w-16">
                جایزه ها
              </span>
          ...
          <div className="flex flex-col gap-2 text-white justify-center items-center">
            <div className="flex flex-col md:gap-1">
              <span className="font-DanaDemiBold text-2xl md:text-3xl leading-[42.9px]">
                542
              </span>
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center bg-gradient-to-r from-orange-200 to-orange-300  rounded-full w-[90px] md:w-[110px] h-[26px] md:h-8"
            >
