...
export default function Header({
  ...
  const [openFloatingCart, setOpenFloatingCart] = useState(false);
  ...
  return (
    <>
      ...
      <svg className="hidden">
        ...
        <symbol
          id="arrow-left-start-on-rectangle"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          strokeWidth="1.5"
      ...
      <header className="hidden md:flex justify-between items-center w-[98%] lg:max-w-[90%]  h-24 mx-auto rounded-3xl backdrop-blur-[6px] px-5 lg:px-10 py-5 z-[9999] fixed top-9 right-0 left-0 bg-black/50">
        {/* menu and logo */}
        <section className="flex justify-between items-center w-full dark:">
            ...
            <ul className="flex gap-x-5 lg:gap-9 gap-5 text-xl text-gray-300 tracking-tightest child-hover:text-orange-300 child:leading-[56px]">
              ...
              >
                ...
                <ul
                  ...
                  }  transition-all  delay-75 flex flex-col absolute top-full w-52  rounded-2xl bg-white border-t-[3px] border-t-orange-300 py-[21px] pr-6  gap-4 text-gray-700  child-hover:text-orange-300 child:transition-colors [&>*>a]:inline-block  dark:bg-zinc-700 dark:text-white text-base tracking-normal shadow-normal`}
                >
                  <li>
                    <a href="">قهوه ویژه</a>
                  </li>
          ...
          {/* shop and dark mode and login  */}
          <div className="text-orange-200 flex items-center xl:gap-10 gap-3">
            <div className="flex gap-x-2 xl:gap-x-5  items-center">
              {/*  cart */}
              <div
                className="relative"
                onMouseOver={() => {
                  setOpenFloatingCart(true);
                }}
                onMouseLeave={() => {
                  setOpenFloatingCart(false);
                }}
              >
                ...
                {/* cart hover */}
                <ShoppingCart isOpenCart={openFloatingCart} />
              </div>

              <div onClick={onChangeTheme} className="cursor-pointer">
            ...
            <span className="w-px block h-14 bg-white/20 "></span>
            <a
              href=""
              className="flex gap-2.5  items-center justify-center tracking-tightest"
            >
              <svg className="h-8 w-8 ">
                <use xlinkHref="#arrow-left-start-on-rectangle"></use>
              </svg>
      ...
      {/* heaer for mobile */}
      <header className="w-full h-16  dark:bg-zinc-700 bg-white md:hidden flex items-center px-4 py-3 ">
        <section className="flex justify-between w-full ">
          ...
          <svg className="w-[100px] text-orange-300 ">
            <use xlinkHref="#logo-type"></use>
          </svg>

          <button type="button" onClick={onOpenShoppingCart}>
            <svg className="size-6 text-zinc-700 dark:text-white">
