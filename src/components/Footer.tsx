export default function Footer() {
  return (
    <>
      ...
      <footer className="h-auto w-auto bg-zinc-700 px-4 pt-8 pb-8 md:px-24 md:pt-[62px] md:pb-12 relative">
        <section className="w-[98%] mx-auto  ">
          <div className="flex flex-col divide-y divide-white/10  ">
            <div className="flex flex-wrap  justify-between items-baseline mb-[54px] gap-y-10">
              {/*logos Site and Description*/}
              <div className="flex flex-col justify-center items-start gap-y-6 md:gap-y-[18px] text-gray-300 w-full md:max-w-[606px] ">
                <div className="flex gap-x-5 items-center justify-center">
                  <svg className="h-[54px] w-[57px] shrink-0">
                    <use href="#logo"></use>
                  </svg>
                ...
                <span className="inline-block text-lg md:text-xl md:leading-[48px]">
              ...
              <div className="flex flex-col justify-center items-center h-auto gap-y-6 md:gap-y-7 w-[289px] md:w-[378px]">
              ...
              <div className="flex justify-center items-center flex-col w-auto">
                <h3 className="mb-7 text-white font-DanaDemiBold text-2xl leading-[28px] md:leading-7 text-right w-full">
                  در تماس باشیم
                </h3>
                {/*address and phone number */}
                <div className="flex flex-col justify-center items-start gap-y-[18px] md:gap-y-5 mb-10 text-gray-300  w-full">
                  <div className="flex justify-center items-center gap-x-2 md:gap-x-3 ">
                    <svg className="size-5 md:size-6 shrink-0">
                      <use href="#map-pin"></use>
                    </svg>
                    <span className="text-base md:text-xl md:h-auto md:w-auto h-12 w-[297px] ">
                      بلوار میرداماد، خیابان البرز، کوچه قبادیان شرقی، پلاک ۳۳
                    </span>
                  </div>
                  <div className="flex flex-wrap md:flex-nowrap gap-y-4 gap-x-5 justify-start md:justify-center items-center w-[297px] md:w-[509px] h-auto ">
                    <a
                      href="#"
                      className="inline-flex justify-center items-stretch gap-x-2 md:gap-x-3 text-orange-300 "
                    >
                      <svg className="size-5 md:size-6 shrink-0">
                        <use href="#envelope"></use>
                      </svg>
                      <span className="font-DanaMedium text-base md:text-xl">
                        info@Coffee.com
                      </span>
                    </a>
                    <div className="flex justify-center items-center gap-x-5 md:gap-x-6 ">
                      <span className="inline-flex justify-center items-stretch gap-x-3">
                        <svg className="size-5 md:size-6 shrink-0">
                          <use href="#phone"></use>
                        </svg>
                        <span
                          dir="ltr"
                          className="font-DanaMedium text-base md:text-xl"
                        >
                          0902 123 6628
                        </span>
                      </span>
                ...
                <div className="flex justify-center items-center gap-x-1.5 md:gap-x-6 w-auto ">
                  <a
                    href=""
                    className="w-44 md:w-[248px] h-12 inline-flex font-DanaMedium  text-base md:text-xl border border-orange-200 rounded-xl  text-orange-200  justify-center items-center gap-x-2"
                  >
                    <svg className="size-[26px] md:size-[38px] my-11 md:my-[5px]  text-orange-200">
                      <use href="#instagram"></use>
                    </svg>
                    <span dir="ltr" className="mb-2.5 mt-3">
                      @golden_coffee
                    </span>
                  </a>
                  <a
                    href=""
                    className="w-44 md:w-[248px] h-12 inline-flex font-DanaMedium text-base md:text-xl border border-orange-200 rounded-xl  justify-center items-center gap-x-2 bg-gradient-to-l  from-orange-300 to-orange-200 text-zinc-700 "
                  >
                    <svg className="size-[26px] md:size-[38px] my-11 md:my-[5px]">
                      <use href="#telegram"></use>
                    </svg>
                    <span dir="ltr" className="my-2.5 mt-3">
                      @golden_coffee
                    </span>
                  </a>
                </div>
            ...
            {/*Copy Right Section*/}
            <div className="text-gray-300 text-xs/5 md:text-base md:leading-[22.8px] font-DanaMedium flex flex-wrap md:flex-nowrap justify-end items-center md:justify-between md:items-end pt-10 gap-y-4 md:pt-11">
              <div className="flex justify-center items-center gap-x-2.5  ">
                <div className="flex items-center justify-center">
                  <div className="rounded-full border border-white/10 size-[30px] shrink-0 flex items-center justify-center p-[5px] ">
                    <div className="rounded-full border border-white/20 shrink-0  size-5 flex items-center justify-center p-[5px] ">
                      <div className="bg-gradient-to-b from-orange-300 to-orange-200 rounded-full size-1.5 "></div>
                    </div>
                  </div>
                </div>
                <span>
                  تمام حقوق این رابط کاربری متعلق به{" "}
                  <span className="text-orange-200">سبزلرن&nbsp;</span>میباشد و
                  دانشجوی این دوره اجازه استفاده آن را در مصارف شخصی و تجاری
                  ندارد.
                </span>
              </div>
              <span dir="ltr" className="leading-[17.16px] ">
                Copyright © 2023 Golden Coffee. All rights reserved.
              </span>
            </div>
          </div>
        </section>
        {/*Toggle btn  scroll up*/}
        <div className="absolute top-0 left-0 right-0 hidden md:flex justify-center items-start ">
